...
<div class="p-6 bg-teal-900 border border-teal-700 rounded-lg shadow-md">
    ...
    <div class="mt-4 flex items-center justify-between">
        <form method="POST" action="{{ route('verification.send') }}">
            ...
            <div>
                <x-primary-button style="background-color: #004d40; color: #EDECD7; border-radius: 20px; outline: 2px solid #00796b; font-family: Inika, serif; text-transform: none">
